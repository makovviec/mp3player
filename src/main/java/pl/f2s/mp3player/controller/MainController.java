package pl.f2s.mp3player.controller;
...
import pl.f2s.mp3player.mp3.Mp3Parser;
import pl.f2s.mp3player.mp3.Mp3Song;
import pl.f2s.mp3player.player.Mp3Player;
    ...
    private void configureMenu() {
        ...
        openDir.setOnAction(event -> {
            ...
            try {
                ...
                showMessage("Wystąpił błąd podczas odczytu z folderu " + dir.getName());
            }
        });
    }
